# Title
# Epistemic Citation Network Analysis

## Overview
This project analyses a scholarly citation network related to scribal education in the Old Babylonian period.  
Sources are classified into epistemic roles based on their structural position in the network, tracing the flow of knowledge from primary data to interpretation, authority, and synthesis.
...
### Epistemic Step-Distance Classification
Each source is assigned a `step_distance` representing its epistemic role.

#### Step 1 — Direct Sources
Works that directly cite primary archaeological reports.  
These sources are closest to fact-based primary data.
